...
umd.output.filename = "./dist/fontpainter-umd.js";

var umdMin = baseConfig();
umdMin.output.libraryTarget = "umd";
umdMin.output.filename = "./dist/fontpainter-umd.min.js";
...
amd.output.filename = "./dist/fontpainter-amd.js";


var cjs2 = baseConfig();
delete cjs2.output.library;
cjs2.output.libraryTarget = "commonjs2";
cjs2.output.filename = "./dist/fontpainter-commonjs.js";
...
system.plugins.push(
	...
	new WebpackSystemRegister({
		...
		registerName: 'fontpainter', // optional name that SystemJS will know this bundle as.
	})
);
system.output.filename = "./dist/fontpainter-systemjs.js";
...
browserMin.output.filename = "./dist/fontpainter.min.js";
